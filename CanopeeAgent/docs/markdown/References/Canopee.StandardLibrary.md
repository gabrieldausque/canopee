...
| public type | description |
| --- | --- |
| abstract class [BaseHardwareInfosInput](Canopee.StandardLibrary.Inputs.Hardware/BaseHardwareInfosInput.md) |  |
| class [DiskInfos](Canopee.StandardLibrary.Inputs.Hardware/DiskInfos.md) |  |
| class [DisplayInfos](Canopee.StandardLibrary.Inputs.Hardware/DisplayInfos.md) |  |
| class [GraphicalCardInfos](Canopee.StandardLibrary.Inputs.Hardware/GraphicalCardInfos.md) |  |
| class [HardwareInfos](Canopee.StandardLibrary.Inputs.Hardware/HardwareInfos.md) |  |
| class [LinuxHardwareInfosInput](Canopee.StandardLibrary.Inputs.Hardware/LinuxHardwareInfosInput.md) |  |
| class [UsbPeripheralInfos](Canopee.StandardLibrary.Inputs.Hardware/UsbPeripheralInfos.md) |  |
| class [WindowsHardwareInfosInput](Canopee.StandardLibrary.Inputs.Hardware/WindowsHardwareInfosInput.md) |  |

## Canopee.StandardLibrary.Inputs.Network namespace

| public type | description |
| --- | --- |
| class [LinuxNetworkInput](Canopee.StandardLibrary.Inputs.Network/LinuxNetworkInput.md) |  |
| class [NetworkInfo](Canopee.StandardLibrary.Inputs.Network/NetworkInfo.md) |  |
| class [WindowsNetworkInput](Canopee.StandardLibrary.Inputs.Network/WindowsNetworkInput.md) |  |

## Canopee.StandardLibrary.Inputs.OperatingSystem namespace

| public type | description |
| --- | --- |
| class [LinuxOperatingSystemInput](Canopee.StandardLibrary.Inputs.OperatingSystem/LinuxOperatingSystemInput.md) |  |
| class [OperatingSystemInfo](Canopee.StandardLibrary.Inputs.OperatingSystem/OperatingSystemInfo.md) |  |
| class [WindowsOperatingSystemInput](Canopee.StandardLibrary.Inputs.OperatingSystem/WindowsOperatingSystemInput.md) |  |

## Canopee.StandardLibrary.Inputs.Trigger namespace

| public type | description |
| --- | --- |
| class [FromTriggerInput](Canopee.StandardLibrary.Inputs.Trigger/FromTriggerInput.md) |  |

## Canopee.StandardLibrary.Loggers namespace

| public type | description |
| --- | --- |
| class [ConsoleCanopeeLogger](Canopee.StandardLibrary.Loggers/ConsoleCanopeeLogger.md) |  |
| class [Log4NetCanopeeLogger](Canopee.StandardLibrary.Loggers/Log4NetCanopeeLogger.md) |  |
| class [MultiCanopeeLogger](Canopee.StandardLibrary.Loggers/MultiCanopeeLogger.md) |  |
