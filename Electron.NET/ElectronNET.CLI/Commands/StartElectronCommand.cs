    ...
    public class StartElectronCommand : ICommand
    {
        ...
        public Task<bool> ExecuteAsync()
        {
            return Task.Run(() =>
            {
                ...
                var publishCommand =
                    $"dotnet msbuild -restore -target:Publish -property:RuntimeIdentifier={platformInfo.NetCorePublishRid} -property:nowarn=1591  -property:OutputPath=\"{tempBinPath}\" -property:SelfContained=true";
