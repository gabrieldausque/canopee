    ...
    public class BuildCommand : ICommand
    {
        ...
        public Task<bool> ExecuteAsync()
        {
            return Task.Run(() =>
            {
                ...
                Console.WriteLine("Executing dotnet publish icd n this directory: " + tempPath);
                ...
                var publishCommand =
                    $"dotnet msbuild -restore -target:Publish -property:RuntimeIdentifier={platformInfo.NetCorePublishRid} -property:Configuration={configuration} -property:nowarn=1591  -property:OutputPath=\"{tempBinPath}\" -property:SelfContained=true";
                Console.WriteLine($"executing {publishCommand} from {Directory.GetCurrentDirectory()}");
